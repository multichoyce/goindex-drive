...
function nav(path) {
    ...
    <a href="https://lmgtfy.com/?q=Retard&iie=1" target="_blank" class="mdui-btn mdui-btn-icon mdui-ripple mdui-ripple-white" mdui-tooltip="{content: 'NF'}">
...
function file_video(path){
	...
	if (/(iPhone|iPad|iPod|iOS|Android)/i.test(navigator.userAgent)) {
	    playBtn = `	<a class="mdui-btn mdui-btn-raised mdui-ripple mdui-color-theme-accent" href="intent:${url}#Intent;package=com.mxtech.videoplayer.pro;S.title=${path};end"><i class="mdui-icon material-icons">&#xe039;</i>Play in mxplayer</a>`;
	}
	var content = `
...
if(search){
    document.write('<script src="//cdn.jsdelivr.net/gh/multichoyce/goindex-drive@2.3/themes/material/cari.js"></script>');
}
